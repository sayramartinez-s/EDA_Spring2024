...
> Answer:
Both can be used for this task. Yet, I used "ifelse" function, because I think it was a simple logical request, since it was only a binary response. "if else" function could help me to better track my conditions in more complex cases.
