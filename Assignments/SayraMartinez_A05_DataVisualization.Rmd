...
library(tidyverse);library(lubridate);library(here); library(dplyr); library(cowplot); library(viridis); library(RColorBrewer); library(colormap)
getwd()
...
sayra.theme <- theme_wsj(base_size = 9) +
...
Phospho.boxplot <-
  ...
  ylab(expression(paste("Total Phosphorus")))+
  theme(axis.text.x = element_blank(),         
        legend.position =  "none")
...
Nitro.boxplot <-
  ...
  ylab(expression(paste("Nitrogen")))+
  theme(legend.position =  "bottom",
        legend.direction =  "horizontal")
print(Nitro.boxplot)

Three.Nutrients <-
plot_grid(Temp.Boxplot, Phospho.boxplot, Nitro.boxplot, nrow = 3, rel_heights = c(1, 1.2, 2.3))
