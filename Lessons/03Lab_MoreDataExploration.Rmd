...
```{r DataExercise-1a}
hightemp_10days <- c(69, 72, 63, 61, 53, 53, 55, 61, 61, 60)
hightemp_10days
lowtemp_10days <- c(64, 57, 56, 41, 31, 36, 33, 37, 39, 40)
lowtemp_10days

temps_Durham <- data.frame(hightemp_10days, lowtemp_10days)
```
...
low_c <- celsius(lowtemp_10days)
print(temp)
high_c <- celsius(hightemp_10days)
print(high_c)
```
